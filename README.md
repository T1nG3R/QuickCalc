...
- **Dual Layout (Standard & Scientific)**: Easily swipe between a standard calculator page and a scientific page featuring functions like `1/x`, `√`, `^`, `x²`, `%` (modulo), `!` (factorial), `π`, `e`, and parentheses.
